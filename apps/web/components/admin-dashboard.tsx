...
function AdminDashboardContent({ testMode }: { testMode: boolean }) {
...
export function AdminDashboard({ testMode = false }: { testMode?: boolean }) {
  return <AdminDashboardContent testMode={testMode} />;
}
